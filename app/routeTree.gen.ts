...
import { Route as AuthIndexRouteImport } from './routes/auth/index/route'
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/auth' | '/records'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/auth' | '/records'
  id: '__root__' | '/(app)' | '/(app)/' | '/auth/' | '/(app)/records'
